<template>
    <portal to="createChatOverlayDest">
        <v-overlay
                :value="overlay"
                :absolute="absolute"
                :opacity="opacity"
            ...
            <v-card class="createChat">
                <v-form>
                    <v-container>
                        <v-card-title class="justify-center">New chat</v-card-title>
                        <v-text-field id="chat-name" label="Chat name" filled shaped></v-text-field>
                        <v-row>
                            <v-col cols="6">
