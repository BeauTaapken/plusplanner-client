                ...
                <v-form>
                    <v-container>
                        ...
                        <v-menu>
                            ...
                            <v-date-picker v-model="date" @input="menu2 = false" width="426" color="#424242" event-color="#424242"></v-date-picker>
                        </v-menu>
    ...
    export default {
        ...
        methods: {
            ...
            save: function() {
                ...
                let index = this.$parent.$parent.$parent.$parent.$parent.itemArray.findIndex(x => x.subpartid = JSON.parse(oldJson).subpartid);
